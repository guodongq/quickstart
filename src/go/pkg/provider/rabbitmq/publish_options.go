...
func WithPublishOptionsMandatory() func(options *PublishOptions) {
	return func(options *PublishOptions) {
...
func WithPublishOptionsImmediate() func(options *PublishOptions) {
	return func(options *PublishOptions) {
...
// are transient
func WithPublishOptionsPersistentDelivery() func(options *PublishOptions) {
	return func(options *PublishOptions) {
